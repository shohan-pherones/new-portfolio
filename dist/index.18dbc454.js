...
var s = [
    ...
    return e.to = function(t, e) {
        var o = this, i = void 0 === e ? {} : e, n = i.duration, l = void 0 === n ? 1 : n, c = i.easing, a = void 0 === c ? function(t) {
            return t;
        } : c, h = function(t, e) {
            if (null == t) return {};
            var o, i, r = {}, n = Object.keys(t);
            for(i = 0; i < n.length; i++)e.indexOf(o = n[i]) >= 0 || (r[o] = t[o]);
            return r;
        }(i, s);
    ...
    var o, r;
    function s(o) {
        var i, r, n, s, c = void 0 === o ? {} : o, a = c.duration, h = void 0 === a ? 1.2 : a, p = c.easing, u = void 0 === p ? function(t) {
            return 1 === t ? 1 : 1 - Math.pow(2, -10 * t);
        } : p, d = c.smooth, f = void 0 === d || d, v = c.smoothTouch, g = void 0 !== v && v, w = c.touchMultiplier, m = void 0 === w ? 2 : w, y = c.direction, b = void 0 === y ? "vertical" : y, S = c.gestureDirection, N = void 0 === S ? "vertical" : S, O = c.wrapper, z = void 0 === O ? window : O, R = c.content, W = void 0 === R ? document.body : R;
        (s = t.call(this) || this).onWindowResize = function() {
            ...
            var e = t.deltaY, o = t.deltaX, i = t.originalEvent;
    ...
    return c.start = function() {
        ...
        var o = void 0 === e ? {} : e, i = o.offset, r = void 0 === i ? 0 : i, n = o.immediate, s = void 0 !== n && n, l = o.duration, c = void 0 === l ? this.duration : l, a = o.easing, h = void 0 === a ? this.easing : a;
        if (null != t) {
            var p;
...
},{}]},["jQVXF","1SICI"], "1SICI", "parcelRequire5b5c")
